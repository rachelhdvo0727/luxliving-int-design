...
const HTML = {};
const linkToHeader = "./components/header.html";
const linkToFooter = "./components/footer.html";
...
function toggleBurgerMenu() {
  HTML.burgermenu = document.querySelector("#burgermenu");
  HTML.dropdown = document.querySelector(".dropdown");

  HTML.bar1 = document.querySelector(".bar1");
  HTML.bar2 = document.querySelector(".bar2");
  HTML.bar3 = document.querySelector(".bar3");

  HTML.burgermenu.addEventListener("click", function () {
    if (HTML.dropdown.classList.contains("hide")) {
      HTML.dropdown.classList.remove("hide");
      setTimeout(() => {
        HTML.dropdown.classList = "dropdown remove_opacity";
      }, 100);

      //transform burgermenu icon
      HTML.bar1.style.transform = "rotate(135deg) translate(5px, -6px)";

      HTML.bar2.style.opacity = "0";
      HTML.bar2.style.left = "-60px";

      HTML.bar3.style.transform = "rotate(-135deg) translate(8px, 8px)";
    } else {
      HTML.dropdown.classList = "dropdown add_opacity";
      setTimeout(() => {
        HTML.dropdown.classList.add("hide");
      }, 500);

      //remove transformation
      HTML.bar1.style.transform = "unset";

      HTML.bar2.style.opacity = "unset";
      HTML.bar2.style.left = "unset";

      HTML.bar3.style.transform = "unset";
    }
  });
}
...
function clickCategory() {
  ...
  for (let category of categories) {
    category.addEventListener("click", () => {
      category.firstElementChild.classList.toggle("hide");
    });
  }
}
...
// }
// //************************
// // Importorted Navigation Script
// // Original: Jet - Menu. Modifications made on this version to fit CfA
// //************************
...
// window.onscroll = function () { headerColorChange() };
